...
public class FirstTenOdd {
    ...
    public static void main(String[] args) {
        ...
        // Steps:
        // 1. Stream.iterate: Creates an infinite stream starting with a seed value (e.g., new long[]{0, 3}).
        //    The lambda expression f -> new long[]{f[1], f[0] + 2} defines how the next pair is generated:
        ...
        //    the actual odd number (the first element of each pair).
        ...
        Stream.iterate(new long[]{1, 3}, f -> new long[]{f[1], f[1] + 2})
                .limit(10)
                .map(f -> f[0])
