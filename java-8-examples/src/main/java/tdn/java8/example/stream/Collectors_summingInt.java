 ...
 * Use: list.stream().collect(Collectors.summingInt(ToIntFunction)
 ...
 */
public class Collectors_summingInt {

    public static void main(String[] args) {
        int theNumber = 15464;
        Integer sumOfDigits = Stream.of(String.valueOf(theNumber).split("")).collect(Collectors.summingInt(Integer::parseInt));
